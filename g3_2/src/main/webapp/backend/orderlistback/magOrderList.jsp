...
<%-- <jsp:useBean id="orderListSvc" scope="page" class="com.orderlist.model.OrderListServiceImpl" /> --%>
<%-- <jsp:useBean id="orderDetailSvc" scope="page" class="com.orderdetail.model.OrderDetailServiceImpl" /> --%>
							...
							<c:forEach var="orderListVO" items="${list}" begin="<%=pageIndex%>"
								...
								<table class="table" style="line-height:14px;">
										...
										<tr>
											...
											<td>${orderListVO.memberVO_cart.memName}</td> 
